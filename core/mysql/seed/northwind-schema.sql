-- Northwind MySQL Database Schema
-- 
-- Adapted from: https://github.com/dalers/mywind
-- Original file: https://raw.githubusercontent.com/dalers/mywind/0036c3ca2f2a010b77c7880a3b4badf85dbcfc7a/northwind.sql
-- 
-- Modifications for The Zoo:
-- - Removed CREATE SCHEMA and USE statements
-- - Removed `northwind.` prefixes from all table references
-- - Now creates tables in the current database (northwind_db)
--
